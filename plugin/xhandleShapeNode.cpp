...
double xhandleShape::dAddScaleX;
double xhandleShape::dAddScaleY;
double xhandleShape::dAddScaleZ;
bool xhandleShape::dDrawOrtho;
short xhandleShape::dDrawStyle;
float dThickness;

static bool dTransformScaling;

static bool dDBlendHColour;
...
MStatus xhandleShape::initialize()
{
	...
	dsAttr.setMin(1);
	dsAttr.setDefault(1);
	dsAttr.setStorable(true);
	dsAttr.setReadable(true);
	dsAttr.setWritable(true);
	dsAttr.setKeyable(true);
	
    MFnEnumAttribute doAttr;
	aDrawOrtho = doAttr.create("drawOrtho", "dro");
	doAttr.addField("Off", 0);
	doAttr.addField("On", 1);
	doAttr.setDefault(1);
	doAttr.setReadable(true);
	doAttr.setStorable(true);
	doAttr.setWritable(true);
	doAttr.setKeyable(true);
    
    MFnNumericAttribute athAttr;
	aThickness = athAttr.create("wireframeThickness", "wt", MFnNumericData::kFloat);
	athAttr.setMin(1.0f);
	athAttr.setDefault(5.0f);
	athAttr.setStorable(true);
	athAttr.setReadable(true);
	athAttr.setWritable(true);
	athAttr.setKeyable(true);
    
    MFnEnumAttribute tsAttr;
	aTransformScaling = tsAttr.create("transformScaling", "tsc");
	tsAttr.addField("Off", 0);
	tsAttr.addField("On", 1);
	tsAttr.setDefault(1);
	tsAttr.setReadable(true);
	tsAttr.setStorable(true);
	tsAttr.setWritable(true);
	tsAttr.setKeyable(true);
    
    MFnNumericAttribute asxAttr;
	aAddScaleX = asxAttr.create("addScaleX", "asx", MFnNumericData::kFloat);
	asxAttr.setDefault(1.0);
	asxAttr.setStorable(true);
	asxAttr.setReadable(true);
	asxAttr.setWritable(true);
	asxAttr.setKeyable(true);
	
    MFnNumericAttribute asyAttr;
	aAddScaleY = asyAttr.create("addScaleY", "asy", MFnNumericData::kFloat);
	asyAttr.setDefault(1.0);
	asyAttr.setStorable(true);
	asyAttr.setReadable(true);
	asyAttr.setWritable(true);
	asyAttr.setKeyable(true);
    
    MFnNumericAttribute aszAttr;
	aAddScaleZ = aszAttr.create("addScaleZ", "asz", MFnNumericData::kFloat);
	aszAttr.setDefault(1.0);
	aszAttr.setStorable(true);
	aszAttr.setReadable(true);
	aszAttr.setWritable(true);
	aszAttr.setKeyable(true);
    
    MFnNumericAttribute asAttr;
    aAddScale = asAttr.create("addScale", "as", aAddScaleX, aAddScaleY, aAddScaleZ);
    asAttr.setStorable(true);
    asAttr.setKeyable(true);
    asAttr.setReadable(true);
    asAttr.setWritable(true);
    
    MFnEnumAttribute bcAttr;
	aBlendHColour = bcAttr.create("blendColour", "bhc");
	bcAttr.addField("Off", 0);
	bcAttr.addField("On", 1);
	bcAttr.setDefault(0);
	bcAttr.setReadable(true);
	bcAttr.setStorable(true);
	bcAttr.setWritable(true);
	bcAttr.setKeyable(true);
    
    MFnEnumAttribute daAttr;
	aDrawAxColour = daAttr.create("drawAxisColour", "daxc");
	daAttr.addField("Off", 0);
	daAttr.addField("On", 1);
	daAttr.setDefault(0);
	daAttr.setReadable(true);
	daAttr.setStorable(true);
	daAttr.setWritable(true);
