...
createNode transform -n "_proxy_elbow_geo_preTransform";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	setAttr -k off ".ty";
	setAttr -k off ".tz";
...
createNode transform -n "_proxy_elbow_geo_scaleTransform" -p "_proxy_elbow_geo_preTransform";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	setAttr -k off ".ty";
	setAttr -k off ".tz";
	...
	setAttr ".rp" -type "double3" 0.50009125471115112 0.5 0.50009119510650635 ;
	setAttr ".sp" -type "double3" 0.50009125471115112 0.5 0.50009119510650635 ;
createNode transform -n "_proxy_elbow_geo" -p "_proxy_elbow_geo_scaleTransform";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	setAttr -k off ".ty";
	setAttr -k off ".tz";
...
createNode mesh -n "_proxy_elbow_geoShape" -p "_proxy_elbow_geo";
